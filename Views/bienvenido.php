...
<div class="row align-items-start p-3">
  <div class="card ml-4 mr-4" style="width: 18rem;">
    <div class="card-body">
      ...
      <p class="card-text text-justify">Aquí podrá consultar todos los recursos informáticos disponibles.</p>
  ...
  <div class="card mr-4" style="width: 18rem;">
    <div class="card-body">
      ...
      <p class="card-text text-justify">Aquí podrá consultar los tramos horarios disponibles.</p>
